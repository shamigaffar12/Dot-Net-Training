...
namespace MVCCC_9.Models
{
    ...
    public partial class northwindEntities : DbContext
    {
        ...
        [EdmFunction("northwindEntities", "fn_GetEmpbyCountry")]
        public virtual IQueryable<fn_GetEmpbyCountry_Result> fn_GetEmpbyCountry(string customercountry)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_GetEmpbyCountry_Result>("[northwindEntities].[fn_GetEmpbyCountry](@customercountry)", customercountryParameter);
        }
