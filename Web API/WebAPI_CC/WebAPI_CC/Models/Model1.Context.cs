...
namespace WebAPI_CC.Models
{
    ...
    public partial class northwindEntities1 : DbContext
    {
        ...
        [DbFunction("northwindEntities1", "fn_GetEmpbyCountry")]
        public virtual IQueryable<fn_GetEmpbyCountry_Result> fn_GetEmpbyCountry(string customercountry)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_GetEmpbyCountry_Result>("[northwindEntities1].[fn_GetEmpbyCountry](@customercountry)", customercountryParameter);
        }
